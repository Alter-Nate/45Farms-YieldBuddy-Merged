...
.textarea { resize:vertical; min-width:900px; max-width:900px; min-height:300px; max-height:1500px; }
a:link {
	color: #999;
...
<table width="1090" align="center">
  ...
  <tr>
    ...
    Send Command
      <p align="right">
        <input type="text" name="command" size="145" />
...
<table width="800" border="0" align="center">
	    <tr>
	    <td height="60" colspan="1" align="center" valign="bottom">
			<?php include $_SERVER['DOCUMENT_ROOT']. "/yieldbuddy/www/stats.php"; ?>
	    </td>
	    </tr>
        <tr>
          <td height="60" colspan="2" align="center" valign="bottom">
		 
		 <button onclick="Restart_yieldbuddy()">Restart yieldbuddy</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="Reboot()">Reboot</button>
         <script language="javascript" type="text/javascript">
			function Restart_yieldbuddy() {
			var r=confirm("Are you sure you want to Restart yieldbuddy?", "Confirm");
			  if (r==true) {
			    window.location.assign("/yieldbuddy/www/command.php?submit=Restart yieldbuddy")
			  }
			}
			function Reboot() {
			var r=confirm("Are you sure you want to Reboot?", "Confirm");
			  if (r==true) {
			    window.location.assign("/yieldbuddy/www/command.php?submit=Reboot")
			  }
			}
         </script>
