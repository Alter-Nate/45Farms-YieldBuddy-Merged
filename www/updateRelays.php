...
//include ($_SERVER['DOCUMENT_ROOT'].'/yieldbuddy/www/sql/sql_relays_firstrow.php');
	  ...
	  {
	  echo "<tr>";
	  echo "<td>Relay 2 (Water Supply 1): </td>";
	...
	//Relay 7
	  ...
	  //echo $Relay7. "<br />";
  	  ...
  	  $Relay7_isAuto = $_SESSION['Relay7_isAuto'];
  		if ($Relay7 == "0") {
	 		echo "<td align=\"center\"><img src=\"img/relay_off.jpg\" title=\"Relay 7 OFF\" alt=\"Relay 7 OFF\" onclick=\"TurnRelay(7, 'on')\"/></td>";
	    	} elseif ($Relay7 == "1") {
	 		echo "<td align=\"center\"><img src=\"img/relay_on.jpg\" title=\"Relay 7 ON\" alt=\"Relay 7 ON\" onclick=\"TurnRelay(7, 'off')\"/></td>";
		}
		if ($Relay7_isAuto == "0") {
			echo "<td align=\"center\"><img src=\"img/manual.jpg\" title=\"Relay 7 Manual\" alt=\"Relay 7 Manual\" onclick=\"TurnAuto(7, 1)\"/></td>";
		} elseif ($Relay7_isAuto == "1") {
			echo "<td align=\"center\"><img src=\"img/auto.jpg\" title=\"Relay 7 Auto\" alt=\"Relay 7 Auto\" onclick=\"TurnAuto(7, 0)\"/></td>";
		}
	  ...
	  {
	  echo "<tr>";
	  echo "<td>Relay 8 (Light/Ballast): </td>";
	  $Relay8=$_SESSION['Relay8'];
	  //echo $Relay8. "<br />";

  	  $Relay8_isAuto = $_SESSION['Relay8_isAuto'];
  		if ($Relay8 == "0") {
	 		echo "<td align=\"center\"><img src=\"img/relay_off.jpg\" title=\"Relay 8 OFF\" alt=\"Relay 8 OFF\" onclick=\"TurnRelay(8, 'on')\"/></td>";
	    	} elseif ($Relay8 == "1") {
	 		echo "<td align=\"center\"><img src=\"img/relay_on.jpg\" title=\"Relay 8 ON\" alt=\"Relay 8 ON\" onclick=\"TurnRelay(8, 'off')\"/></td>";
		}
		if ($Relay8_isAuto == "0") {
			echo "<td align=\"center\"><img src=\"img/manual.jpg\" title=\"Relay 8 Manual\" alt=\"Relay 8 Manual\" onclick=\"TurnAuto(8, 1)\"/></td>";
		} elseif ($Relay8_isAuto == "1") {
			echo "<td align=\"center\"><img src=\"img/auto.jpg\" title=\"Relay 8 Auto\" alt=\"Relay 8 Auto\" onclick=\"TurnAuto(8, 0)\"/></td>";
		}
